'''
Runs the NER pipeline including generation, testing on generation, and on original/real dataset
'''
from config import *
...
caching: bool = True
k_shot: int = 15
number_of_examples_per_intent: int = k_shot
number_of_examples: int = 200
task: str = "ner"
use_redis_caching: bool = True
port: int = 6379
number_of_examples_per_score: int = k_shot
