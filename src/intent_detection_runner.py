...
including generation, testing on generation, and on original/real dataset
'''
...
split: str = "test"
caching: bool = True
number_of_examples_per_intent: int = 2
k_shot: int = number_of_examples_per_intent
number_of_examples: int = 200
task: str = "intent"
use_redis_caching: bool = True
port: int = 6379
number_of_examples_per_score: int = number_of_examples_per_intent
...
print("*********test on generated dataset*********")
#
# #
